...
public class telaInicial extends JFrame implements MouseListener, KeyListener {
	...
	// Criando evento no mouse ( Caso queira adicionar um Hover no bot�o por
	// exemplo)
	@Override
