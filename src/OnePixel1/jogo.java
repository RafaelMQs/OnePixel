...
public class jogo extends JFrame {
	...
	private String[] TextoDoGuri = {
			"<html>Guri: Estou caminhando bem devagar.<br> <br><center> Ser� que: 1� Devo Correr ou 2� NAO correr",
			// ESCOLHER NAO CORRER
			"<html>Guri: Caraca!, achei um pixel. Isso at� que foi bem f�cil, mas qual pixel ser� esse?",
			"<html>Guri: Coletei um pixel vermelho. At� o cen�rio mudou. Pelo visto estou bem perto de encontrar os outros, melhor continuar caminhando com um passo de cada vez.",
			"<html>Guri: Agora devo escolher uma outra dire��o para ir, estou sentindo algo bom para o sul. <br> <br> <center> 1� Ir para o sul ou 2� NAO ir para o sul",
			// ESCOLHER NAO IR PARA O SUL
			"<html>Guri caminha ao norte e se depara com uma cidade abandonada.<br><br>Guri: Essa cidade � de dar medo.<br> <br> <center> 1� Ir embora ou 2� NAO ir embora",
			// ESCOLHER NAO IR EMBORA
			"<html>Guri: Independente de minha escolha... � melhor entrar, sinto que estou sendo for�ado a entrar.<br><br>Guri: H� uma casa com a porta aberta logo ali em frente.<br><center> 1� Ir at� l� ou 2� NAO ir at� l�",
			// ESCOLHER NAO IR AT� A CASA
			"<html>Guri: Caraca, que coincid�ncia, no final desta cidade est� mais um pixel!",
			"<html>Guri: Uau, ele � verde! Estou um passo mais perto de recuperar todas as cores e de me encontrar com os meus pais!",
			"<html>Guri: Esses pixels est�o muito f�ceis de serem encontrados, isso est� meio estranho... � melhor eu NAO pensar nisso. Logo ali na frente h� uma floresta. <br><br><center> 1� Entrar na floresta ou 2� NAO Entrar ",
			// ESCOLHER NAO ENTRAR NA FLORESTA
			"<html>Guri: Okay, eu NAO posso ficar parado aqui. Logo ao lado h� uma Cidade Grande.<br><br><center> 1� Entrar na Cidade Grande ou 2� NAO Entrar",
			// ESCOLHER ENTRAR NA CIDADE GRANDE
			"<html>Guri: Independente de minha escolha... � melhor entrar, sinto que estou sendo for�ado a entrar.<br><br>Guri: Que cidade meio estranha, mas Okay. Opa, parece que tem um pixel azul no cassino.<br><br><center> 1� Entrar ou 2� NAO Entrar",
			"<html>Guri: Independente de minha escolha... � bom eu ir para o cassino, tem um pixel l�! xD",
			...
			"<html>Guri: Eba, consegui. Este � o ultimo pixel, agora poderei ver minha fam�lia.",
			// ESCOLHER TENTAR A SORTE E ERRAR
			"<html>Guri: Droga, perdi. Acho que vou ter que roubar, ainda bem que NAO tem ningu�m olhando.",
			// ESCOLHER ROUBAR
			"<html>Guri: Acho que vou ter que roubar, ainda bem que NAO tem ningu�m olhando, ent�o consigo fazer isso sem pensar que � algo errado.",
			// DIALOGO FINAL
			"<html>Guri: Finalmente consegui completar essa miss�o, que foi bem estranha e f�cil por sinal. Agora poderei ver minha fam�lia.",
			"<html>Guri: Oshi, porque eu estou aqui, cad� minha familia, cad� tudo?" };// Texto do Guri

	private JLabel dialogoDoGuri; // Di�logo do Guri

	private String[] TextoDoZero = {
			"<html>Zero: Voc� achou mesmo que essa era a miss�o verdadeira, tipo... s�rio? Voc� conseguia reviver cara, eu basicamente facilitei e at� mesmo manipulei algumas escolhas suas para voc� chegar at� aqui. Isso foi muito f�cil, era apenas um teste",
			"<html>Zero: Agora que voc� j� sabe tem duas escolhas: <br><br><center>1� Permanecer na matrix ou 2� Enfrentar a realidade",
			"<html> EM BREVE... <br><br><center> ONE PIXEL 2",
			"<html>Zero: Voc� achou mesmo que essa era a miss�o verdadeira, tipo... serio? Voc� conseguia reviver cara. Isso foi muito facil, eu basicamente facilitei e at� mesmo manipulei algumas escolhas suas para voc� chegar at� aqui, tirando a parte que voc� roubou um pixel, mas irei relever, era apenas um teste para ver se era voc� mesmo o escolhido" }; // Texto
																																																																																											// do
																																																																																											// Guri

	private JLabel dialogoDoZero; // Di�logo do Guri

	private String[] TextoDoConsole = {
			"<html>Guri correu t�o rapido que bateu no pixel com muita for�a. <br><br><center>Voc� MORREU! <br><br><center> 1� Recome�ar ou 2� Sair",
			"<html>Guri ficou andando sem rumo por muito tempo.<br><br><center>VOC� MORREU DE CANSA�O! <br><br><center> 1� Recome�ar ou 2� Sair",
			"<html>Guri entrou na casa, porem, nao era uma casa e sim um po�o artesiano em formato de casa.<br><br><center>VOC� MORREU DE QUEDA! <br><br><center> 1� Recome�ar ou 2� Sair ",
			"<html>Guri entrou na floresta, mas NAO estava preparado para o ambiente.<br><br><center> VOC� MORREU DE MEDO ( LITERALMENTE ) <br><br><center> 1� Recome�ar ou 2� Sair" }; // Mensagens
																																														// do
																																														// jogo
																																														// em
																																														// si
	...
	public void Componentes() {
		...
		// BAL�O DE FALA
		balaoOpen = new JLabel(new ImageIcon("res/imgBalao/Bal�oOpen.gif"));
