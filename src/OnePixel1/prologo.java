...
public class prologo extends JFrame implements KeyListener {
	...
	private String[] Dialogo = { "<html>Era mais um dia normal no Mundo Virtual.",
			...
			"<html>Guri odiava faxina, Ent�o sem pensar duas vezes ele disse:",
			"<html>�Se eu fosse a �nica pessoa nesse mundo tudo seria diferente�",
			"<html>Ap�s o �ltimo som de sua voz, tudo come�ou a tremer e o que estava ao seu redor foi consumido pela...",
			"<html>ESCURID�O",
			"<html>Guri, ficou 15 horas naquele breu. Ainda afobado na escurid�o ele descobriu algo que o fez chorar. Ele percebeu que ele NAO aproveitou nada em sua vida, pois era apenas um ego�sta.",
			"<html>Enquanto Guri estava em total desespero... Ele ouve a seguinte frase:",
			"<html>Voc� sabe quantas cores h� no mundo virtual? Voc� consegue acend�-las?" };
