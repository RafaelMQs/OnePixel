...
public class Introduction extends JPanel {
	...
	private JLabel imgFundo0, imgFundo1, guriPretoBrancoAndando, guriPretoBranParado, GuriParadoColorido,
			GuriAndandoColorido, GuriComTochaColorido, balaoOpen, balaoFixo, balaoClose, opcaoS, opcaoN, zeroGif,
			Op1NoSelected, Op1Selected, Op2NoSelected, Op2Selected;
	...
	private String[] TextoDoGuri = { "<html>Guri: Quem é você? O que Aconteceu? Onde Estou?",
			...
			"<html>Guri: !?", "<html>Guri: He he... Pensando bem... Posso mudar de opção?",
